...
read -p "Enter spesific version ex: v0.70.0 (press enter for the latest version): " VERSION
if [[ -z "$VERSION" ]]; then
...
export ENABLED_NETWORKS='arbitrum-sepolia,base-sepolia,optimism-sepolia,l2rn,unichain-sepolia,monad-testnet'
export EXECUTOR_ENABLED_NETWORKS='arbitrum-sepolia,base-sepolia,optimism-sepolia,l2rn,monad-testnet'
